...
# #Ejemplo 16, Crear un ciclo infinito que pida una cadena de texto la ponga en mayúsculas y 
# #la imprima hasta que se ingrese la palabra salir
...
#Ejercicio 6, Crear una matriz ingresando un número por teclado para el tamaño de la matriz
#  y en cada posición colocar una tupla con (i, j)
print ("Ejercicio 6")
n = int(input("Ingrese un número: "))
